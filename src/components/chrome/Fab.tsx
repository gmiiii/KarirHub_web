...
export function Fab() {
  return (
    <button
      ...
      className="group fixed bottom-20 right-5 z-[var(--z-fab)] flex h-14 w-14 items-center justify-center rounded-full bg-primary text-on-primary shadow-level-3 transition-transform duration-200 ease-out-quint hover:scale-110 active:scale-90 md:bottom-8 md:right-8"
    >
